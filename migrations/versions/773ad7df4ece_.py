...
Revision ID: 773ad7df4ece
Revises: 
Create Date: 2022-05-14 18:43:09.395478
...
def upgrade():
    ...
    sa.Column('show_link', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('id', sqlmodel.sql.sqltypes.GUID(), nullable=False),
    sa.ForeignKeyConstraint(['show_link'], ['show.show_link'], ),
    ...
    op.create_index(op.f('ix_image_show_link'), 'image', ['show_link'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_image_show_link'), table_name='image')
